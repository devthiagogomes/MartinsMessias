  ...
  return (
    <div className="container">
      ...
      <div className="upper-values">
        <div className="values-container">Inovação Contínua e Excelência Técnica</div>
        <div className="values-container">Confiabilidade e Integridade</div>
      </div>
      <div className="values-container lower-values">Responsabilidade Fiscal</div>
      </div>
      <Space height={6} />
      <div className={"sub-text"}>
        Nosso escritório dedica-se a oferecer soluções jurídicas empresariais
        construídas sobre os pilares da{" "}
        <span className="highlight">transparência</span> em cada interação.{" "}
      </div>
      <Space height={2} />
      <div className={"sub-text"}>
      ...
      <div className={"sub-text"}>
        ...
        clientes, e por isso, nosso compromisso é prover uma assessoria jurídica
        ...
        , sempre em estrita conformidade com os preceitos éticos da advocacia.
      </div>
    </div>
  );
}
